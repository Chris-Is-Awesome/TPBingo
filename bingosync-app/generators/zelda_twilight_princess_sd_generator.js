// Random math function, don't touch this
...
// Returns a random key from the bingoList obj
...
var defaultOpts = {
	seed: String(Math.ceil(999999 * Math.random())), // Seed for random number generator
	length: 3, // How many bingo goals to generate (25 is normal). May be fewer based on constraints
};

/** Generates bingo list
 * @param {object} bingoOptions Contains all available options and constraints
 * @param {object} optsIn Options -- See defaultOptions for structure
 * */
...
// BEGIN TEST CODE
var result = generateBingoList(bingoOptions); // Use this if you want randomized goals
//var result = generateBingoList(bingoOptions, { seed: "69420", length: 25 }); // Use this if you want to test a specific seed/# of goals
