...
bingoGenerator = (function () {
  ...
  var bingoList = {
    ...
    CuccoAbuse3: 'Take Control of a Cucco in Ordon Village, Kakariko Village & Lake Hylia',
  ...
  var types = {
		...
		castleTown: ["ShoePolish", "CTBread", "CTApple", "CTFlower", "CTPedsTalk", "CharloDonation", "BuyCTMaloMart", "Jovanni20Souls", "Jovanni60Souls", "LoveHint", "CareerHint"],
		izaMG: ["Iza1", "Iza2", "IzaPts0", "IzaPts30"],
		starMG: ["Star1", "Star2", "StarDeath"],
