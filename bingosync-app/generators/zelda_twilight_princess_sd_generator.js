...
bingoGenerator = (function () {
  ...
  var bingoList = {
    ...
    GibdoKills: 'Kill 5 Gibdos (Redeads)',
    GibdoKillsBombArrows: 'Kill a Gibdo (Redead) with Bomb Arrows',
    ...
    MapUnlock: 'Unlock All Provinces of the Map',
    ...
    PostmanTalk:
      'Talk to the Postman in 2 Different Locations (not via mail delivery)',
    ...
    TreasureRoom: 'Riad Hyrule Castle Treasure Room',
  ...
  return function bingoGenerator(options) {
